...
// ✅ GET — for admin dashboard stats
export async function GET() {
  return NextResponse.json([]); // no DB, return empty
}
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #0f0f0f; color: #fff; border-radius: 12px;">
          <h2 style="color: #00f5ff; margin-bottom: 24px;">🚴 New Contact Form Submission</h2>
          ...
          <div style="margin-top: 16px; padding: 16px; background: #1a1a1a; border-radius: 8px; border-left: 4px solid #00f5ff;">
